...
<jsp:useBean id="UpdatePoolBean" scope="page" class="exam.ExamBean"/>
<%  
...
if(username!=null && tpri.intValue()==2){
	...
	if(answer4!=null)
	answer+=answer4;
	String UpdateSql="update pool set subj='"+subject+"',type='"+type+"',question='"+question+"',option1='"+
	option1+"',option2='"+option2+"',option3='"+option3+"',option4='"+option4+"',answer='"+answer+"' where sequence='"+Sequence+"'";
	System.out.println(new Date());
	UpdatePoolBean.executeUpdate(UpdateSql);
	System.out.println(new Date());
	UpdatePoolBean.closeStmt();
	System.out.println(new Date());

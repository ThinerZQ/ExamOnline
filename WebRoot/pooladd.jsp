...
<table width="363" border="0" cellspacing="0">
  <tr>
    <td width="361"><span class="style1">当前位置：<a href="logout.jsp">登录页</a>&gt;&gt;<a href="teaclogin.jsp">教师主界面</a>&gt;&gt;添加题目</span></td>
  </tr>
</table>
<BR>
<form name="form1" method="post" action="pooladd1.jsp">
  <div align="center">
    <table width="570" height="307" border="1" cellspacing="1" bordercolor="#799AE1">
      ...
      <tr>
        <td width="76" class="trh"><div align="center">科目
        </div></td>
	...
	%>
        ...
        <td width="79" class="trh"><div align="center">题型
        </div></td>
      ...
      <tr>
		...
		<input name='checkbox1' type='checkbox' id='checkbox1' value='A'>正确答案</td>
      </tr>
      <tr>
		...
		<input name='checkbox2' type='checkbox' id='checkbox2' value='B'>正确答案
        </td>
      </tr>
      <tr>
        ...
        <td height="40" class="trh1">
		<input name='checkbox3' type='checkbox' id='checkbox1' value='C'>正确答案
        </td>
      </tr>
      <tr>
        ...
        <td height="40" class="trh1">
		<input name='checkbox$' type='checkbox' id='checkbox$' value='D'>正确答案
        </td>
      </tr>
    </table>
  </div>
